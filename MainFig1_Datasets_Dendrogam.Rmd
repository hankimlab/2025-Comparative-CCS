...
# ccs only objects
fccs <- readRDS('farah_ccs_20240910.rds') # Farah et al, Nature 2024 (human fetal - 9-15pcw)
lccs <- readRDS('protze_fetal_san_pacemakeronly.rds') # Lim et al, Nat Commun 2024 (human fetal - 19pcw)
...
zccs_e <- readRDS('zebrafish_ccs_20250706.rds') # Abu Nahia et al, iScience 2024 (zebrafish embryonic)
zccs_a <- readRDS('zebrafish_ccs_adult_li.rds') # Li et al, Nat Commun 2024 (zebrafish adult - SA node)
zf_mdk_trbc <- readRDS('zf_mdk_trbc_20250706.rds') # Carey et al, Biol Open 2024 (zebrafish adult - trabeculae)
rccs <- readRDS('rat_ccs_20250401.rds') # Arduini et al, Cell Rep 2025 (rat adult)
...
ggsave('mp_umap_no_legend.tiff', fig, width=7, height=5)
...
ggsave('me_umap_no_legend.tiff', fig, width=7, height=5)
...
ggsave('ha_umap_no_legend.tiff', fig, width=7, height=5)
...
ggsave('he_umap_no_legend.tiff', fig, width=7, height=5)
